...
In particular, a Frobenius algebra homomorphism preserves the Frobenius form (i.e. $\varepsilon' = \varphi(\varepsilon)$). Together with such morphisms, Frobenius algebras then form a category, which we name $\mathbf{FAlg}_\Bbbk$.
...
Commutative Frobenius algebras form a full subcategory, which we denote as $\mathbf{cFAlg}_\Bbbk$.