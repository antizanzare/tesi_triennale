...
In particular, a Frobenius algebra homomorphism preserves the Frobenius form (i.e. $\varepsilon' = \varphi(\varepsilon)$). Together with such morphisms, Frobenius algebra then forma a category, which we name $\mathbf{FA}_\Bbbk$.

We now investigate the structure of this category.

\begin{tcblemma}
A Frobenius algebra homomorphism is always invertible in $\mathbf{FA}_\Bbbk$. 
\end{tcblemma}

\begin{tcblemma}
The tensor product of two Frobenius algebra is again a Frobenius algebra, giving $\mathbf{FA}_\Bbbk$ a monoidal structure.
\end{tcblemma}
