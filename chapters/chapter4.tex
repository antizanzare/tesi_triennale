...
\begin{tcbdfn}[Symmetric Frobenius algebras]
 ...
 \end{enumerate}
\end{tcbdfn}
The difference between a commutative and a symmetric Frobenius algebra becomes clear: a \emph{commutative Frobenius algebra} is indeed just a Frobenius algebra whose underlying algebra is commutative. We then have that all commutative Frobenius algebras are symmetric, while the viceversa does not hold.
\par
...
The aim of this section is to define a graphical language that will help us see more clearly the equivalence between the various definitions of Frobenius algebras.
\todo[inline]{add a note about such choice. kock used bordisms, why do we like wires?}
...
Their relation can be explaned graphically as follows.
...
\[
 ...
 \end{tikzpicture}
\]
(The first follows from the definition of comultiplication and unit axioms. The second from counit axioms.)
\todo[inline]{show??}
