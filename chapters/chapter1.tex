...
\begin{tcbprp}\label{prp:cartesian-monoidal}
    Let $\cat{C}$ be a category that admits products. Then $(\cat{C}, \times, 1)$, where $\times$ denotes the product and $1$ the terminal object, is a monoidal category.
\end{tcbprp}
\begin{proof}
