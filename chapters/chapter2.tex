...
An \emph{$n$-dimensional topological quantum field theory} \index{topological quantum field theory} is a symmetric monoidal functor from $(\bord{n}, \disj, \varnothing, T)$ to $(\mathbf{Vect}, \tensor, \Bbbk, \sigma)$
\end{tcbdfn}
