...
\begin{proof}
 ...
 Through such a homeomorphism, we can define a new smooth structure on $M'N'$, which by Theorem~\ref{th:collar_diffeo} is diffeomorphic to the one induced by the glueing.
\end{proof}
