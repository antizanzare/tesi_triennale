...
\begin{remark}
 ...
 Our definition of bordisms with fixed collars is given precisely to specify this choice, making the glueing to be exactly the pushout in the proper category (which we can imagine as the category of ``manifolds with defined collars'').
