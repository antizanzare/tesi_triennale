...
\begin{example}
  We illustrate such procedure with the following example. Take a bordism $(X, i_0, i_1)$ from $Y_0 = \mathbb{S}^1 \disj \mathbb{S}^1$ to $Y_1 = \mathbb{S}^1$ and a bordism $(X', i'_0, i'_1)$ from $Y_1 = \mathbb{S}^1$ to $Y_2 = \mathbb{S}^1$. 
  % \begin{figure}[H]
  %   \centering
  %   \begin{tikzpicture}
  %     \pic[name=a, tqft, offset=-0.7, incoming boundary components=1,
