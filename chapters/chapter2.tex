...
A neighbourhood of $\partial M$ is called a \emph{collar neighbourhood}\index{collar neighbourhood} if it is the image of a smooth embedding $\partial M \times [0, \varepsilon) \to M$, that restricts to the identification $\partial M \times \{0\} \to \partial M$.
\end{tcbdfn}
