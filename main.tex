...
\newcommand{\fouche}[1]{\relax}%{\todo[inline, caption=0,color=red!10,bordercolor=red!10]{\textbf{fouche said}: #1}}
...
\hypersetup{
  pdftitle={An Introduction to Frobenius Algebras and 2D TQFTs},
  pdfauthor={Chiara Poles},
  colorlinks=true,
  allcolors=black,
}
