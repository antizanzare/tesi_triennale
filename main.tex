...
\newcommand{\bordpants}{
    ...
    \begin{tikzpicture}[every tqft/.style={transform shape}, scale=0.15]
        \pic[tqft pair of pants, rotate=90, draw, every lower boundary component/.style={draw}];
    \end{tikzpicture}
    }
}
...
\newcommand{\bordcopants}{
    ...
    \begin{tikzpicture}[every tqft/.style={transform shape}]
        \pic[tqft reverse pair of pants, rotate=90, scale=0.15, draw, every lower boundary component/.style={draw}];
    \end{tikzpicture}
    }
}
